...
const projects = [
  ...
  { id: 9,  image: '/projetos/4irmaos-logo.jpeg',                        category: 'Branding',              title: '4 Irmãos',                   desc: 'Identidade visual sofisticada com conceito editorial para marca de alto padrão.' },
  { id: 10, image: '/projetos/deltatoners-logo.jpg',                     category: 'Branding',              title: 'Delta Toners',               desc: 'Criação de logo e identidade visual para empresa de cartuchos e toners.' },
  { id: 11, image: '/projetos/flx-fiscolex-itapetininga.jpg',            category: 'Redes Sociais',         title: 'FLX Fiscolex',               desc: 'Conteúdo e presença digital para assessoria empresarial e contabilidade.' },
  { id: 12, image: '/projetos/sou-europeu-portugal.jpg',                 category: 'Redes Sociais',         title: 'Sou Europeu',                desc: 'Estratégia de conteúdo para assessoria de dupla cidadania portuguesa.' },
  { id: 13, image: '/projetos/stuque-odontologia-dia-maes.jpg',          category: 'Redes Sociais',         title: 'Stuque Odontologia',         desc: 'Criação de posts sazonais e gestão de redes sociais para clínica odontológica.' },
  { id: 14, image: '/projetos/paroquia-santa-rita-instagram.jpeg',       category: 'Redes Sociais',         title: 'Paróquia Santa Rita',        desc: 'Estratégia e criação de conteúdo digital para instituição religiosa.' },
  { id: 15, image: '/imagens/assessoria-imprensa-tv.jpg',                category: 'Assessoria de Imprensa',title: 'Entrevista para TV',          desc: 'Assessoria de imprensa com cobertura em veículo televisivo regional.' },
  { id: 16, image: '/imagens/assessoria-imprensa-radio.jpg',             category: 'Assessoria de Imprensa',title: 'Participação em Rádio',       desc: 'Estratégia de assessoria de imprensa com inserção em programa de rádio e podcast.' },
  { id: 17, image: '/imagens/assessoria-imprensa-nativa-fm.jpg',         category: 'Assessoria de Imprensa',title: 'Nativa FM 101.1',             desc: 'Assessoria de imprensa com visita e divulgação na Nativa FM Itapetininga.' },
  { id: 18, image: '/imagens/producao-video-sincomercio.jpg',            category: 'Produção de Conteúdo',  title: 'Vídeo Sincomercio',          desc: 'Produção de vídeo institucional para o Sincomercio Regional Itapetininga.' },
  { id: 19, image: '/imagens/producao-evento-show.jpg',                  category: 'Produção de Conteúdo',  title: 'Cobertura de Show',          desc: 'Cobertura fotográfica e de conteúdo em evento musical de grande porte.' },
]
